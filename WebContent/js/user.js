...
function resLogin()
{
 ...
 if(userStatus=="1"||userStatus=="4"||userStatus=="5"){
		if(userType=='0'||userType=='1'||userType=='4'||userType=='5')//普通用户或管理员用户或临时用户或批量用户
		{
			window.location.href="selfaccount.html";
		}else if(userType=='2')//机构用户
		{
			window.location.href="institutionaccount.html";
		}else if(userType=='3')//教育中心
		{
...
function quit(){
	...
	window.location.href="/EcossWeb/index.html";
}
